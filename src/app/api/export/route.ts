...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    asset_cards: db.prepare("SELECT * FROM asset_cards").all(),
    asset_components: db.prepare("SELECT * FROM asset_components").all(),
    asset_logs: db.prepare("SELECT * FROM asset_logs").all(),
